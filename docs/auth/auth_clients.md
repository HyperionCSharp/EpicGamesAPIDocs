...
You can see the permissions of an auth client by looking at the [permissions folder](https://github.com/HyperionCSharp/EpicGamesAPIDocs/tree/main/docs/auth/permissions) and the file with the corresponding client ID.
